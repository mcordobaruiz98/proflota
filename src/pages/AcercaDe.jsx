      ...
      <div style={styles.contenido}>
        ...
        <div style={styles.seccion}>
          ...
          {abierto.privacidad && (
            <div style={styles.cuerpo}>
              {[
                {titulo:"1. Datos que recolectamos", texto:"Correo electrónico para autenticación. Datos de vehículos, viajes y gastos que tú mismo ingresas. Fotos de vehículos, manifiestos y facturas que tú mismo subes."},
                {titulo:"2. Cómo usamos tus datos", texto:"Para mostrarte tu información dentro de la app y calcular tus ganancias y gastos. No usamos tus datos para publicidad ni los compartimos con terceros."},
                {titulo:"3. Almacenamiento", texto:"Tus datos se almacenan en Firebase (Google) con cifrado en tránsito y en reposo. Solo tú puedes acceder a ellos mediante tu cuenta autenticada."},
                {titulo:"4. Datos recolectados por el bot de Telegram", texto:"Cuando el usuario registra información a través del bot de Telegram, NAVIRA almacena: el identificador de chat de Telegram asociado a su cuenta (para la vinculación), el estado temporal de la conversación en curso, y los datos del viaje que el usuario confirme guardar. NAVIRA no accede a otros chats, contactos ni información del dispositivo del usuario en Telegram. Los mensajes intercambiados con el bot son procesados exclusivamente para completar el registro solicitado por el usuario."},
                {titulo:"5. Tus derechos (Ley 1581 de 2012)", texto:"De conformidad con la Ley 1581 de 2012 y sus decretos reglamentarios, como titular de los datos personales tienes derecho a: conocer, actualizar y rectificar tus datos; solicitar la supresión de tus datos cuando no exista obligación legal o contractual de conservarlos; revocar la autorización otorgada para el tratamiento; acceder de forma gratuita a tus datos. Puedes ejercer estos derechos eliminando tu cuenta desde Configuración o contactándonos directamente."},
                {titulo:"6. Cookies", texto:"No usamos cookies de rastreo ni tecnologías de seguimiento de terceros."},
                {titulo:"7. Cambios", texto:"Podemos actualizar esta política. Te notificaremos mediante la aplicación. El uso continuado de NAVIRA después de la publicación de cambios constituye la aceptación de la política actualizada."},
              ].map((item,i)=>(
                <div key={i} style={{marginBottom:"12px"}}>
                  <p style={{fontSize:t.fonts.sizeXs, fontWeight:t.fonts.weightBold, color:t.colors.textPrimary, margin:"0 0 4px"}}>{item.titulo}</p>
                  <p style={{fontSize:t.fonts.sizeXs, color:t.colors.textSecondary, margin:0, lineHeight:"1.6"}}>{item.texto}</p>
