...
const styles = {
  ...
  accesoCard:        { display: "flex", flexDirection: "column", alignItems: "center", gap: "6px", padding: "14px 8px", borderRadius: t.radius.lg, cursor: "pointer", transition: "transform 0.1s" },
  accesoIcono:       { fontSize: "24px" },
  accesoLabel:       { fontSize: "11px", fontWeight: t.fonts.weightSemibold, color: t.colors.textPrimary },
