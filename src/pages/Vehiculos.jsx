...
// Placa colombiana — integrada aquí para evitar problemas de resolución de módulos
function Placa({ valor, size = "md" }) {
  ...
  return (
    <span style={{
      ...
      fontSize: dims.fontSize, lineHeight: 1.4, textTransform: "uppercase", whiteSpace: "nowrap",
    }}>{valor}</span>
  );
}
