...
// Pantalla de carga NAVIRA — integrada aquí para evitar problemas de resolución de módulos
function PantallaCarga() {
  return (
    <div style={pcStyles.contenedor}>
      <style>{`
      ...
      <p style={pcStyles.logo}>NAVIRA</p>

      <div style={pcStyles.escena}>
        <div className="navira-camion" style={pcStyles.camionWrapper}>
        ...
        <div style={pcStyles.via}>
          <div className="navira-via" style={pcStyles.lineasVia}>
            {Array.from({length: 20}).map((_,i)=>(
              <div key={i} style={pcStyles.lineaVia} />
            ))}
          </div>
        </div>
      </div>

      <p className="navira-texto" style={pcStyles.cargando}>Cargando su flota...</p>
    </div>
  );
}
